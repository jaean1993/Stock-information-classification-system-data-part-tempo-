...
(function($){
  ...
  $(document).ready(function(){
    ...
    var demos = {
      nodes:{
    	     股票C:{color:CLR.or, shape:"dot", alpha:1,tp:1},
    	     股票A:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:'http://localhost:5858/test/src/main/webapp/a.html'},    
    	     ...
    	     股票D:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:'http://localhost:5858/test/src/main/webapp/d.html'},
