...
(function($){
      ...
      _initMouseHandling:function(){ //鼠标事件
        ...
        var handler = {
          moved:function(e){
            ...
            }else if ($.inArray(nearest.node.name, ['节日','中国传统节日','台湾节日','中国纪念日','宗教节日']) >=0 ){
  ...
  $(document).ready(function(){
    ...
    var demos = {
      nodes:{"节日":{color:"red", shape:"dot", alpha:1},    
             中国传统节日:{color:CLR.branch, shape:"dot", alpha:1}, 
             清明节:{color:CLR.资本证券, alpha:1, link:''},
             端午节:{color:CLR.资本证券, alpha:1, link:''},
             中秋节:{color:CLR.资本证券, alpha:1, link:''},
             春节:{color:CLR.资本证券, alpha:1, link:''},
             除夕:{color:CLR.资本证券, alpha:1, link:''},
             重阳节:{color:CLR.资本证券, alpha:1, link:''},
             
             台湾节日:{color:CLR.branch, shape:"dot", alpha:1}, 
             台湾光复节:{color:CLR.b, alpha:1, link:''},
             台湾青年节:{color:CLR.b, alpha:1, link:''},
             和平纪念日:{color:CLR.b, alpha:1, link:''},
             
             中国纪念日:{color:CLR.branch, shape:"dot", alpha:1},
             建军节:{color:CLR.货币证券, alpha:1, link:''},
             国庆节:{color:CLR.货币证券, alpha:1, link:''},
           
             宗教节日:{color:CLR.branch, shape:"dot", alpha:1},
             基督教圣诞:{color:CLR.股票, alpha:1, link:''},
             伊斯兰斋月:{color:CLR.股票, alpha:1, link:''},
             犹太住棚节:{color:CLR.股票, alpha:1, link:''},
             佛诞节:{color:CLR.股票, alpha:0, link:''},
            },
      edges:{
        "节日":{
          中国传统节日:{length:.8},
