...
*/
  ...
  $(document).ready(function(){
    ...
    var demos = {
      nodes:{
    	  股票A:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:'http://localhost:5858/test/src/main/webapp/index4.html'},    
    	     股票B:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
    	     股票E:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
    	     股票F:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
             股票G:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
             
             股票C:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''}, 
             股票H:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:'http://localhost:5858/test/src/main/webapp/index5.html'},
             股票I:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
             股票J:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
             
             股票D:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
             股票K:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
             股票L:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
             股票M:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
             股票N:{color:CLR.branch, shape:"dot", alpha:1,tp:1,link:''},
    ...
    sys.parameters({stiffness:900, repulsion:2000, gravity:true, dt:0.001})
    sys.graft(demos)
