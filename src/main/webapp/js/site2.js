...
(function($){
    ...
    var that = {
     ...
     switchMode:function(e){ //将不透明度逐渐改变为设定的值
      ...
      _initMouseHandling:function(){ //鼠标事件
        ...
        var handler = {
          moved:function(e){
            var pos = $(canvas).offset();//获取匹配元素在当前视图的相对偏移
            ...
            if (1){
              ...
              if (selected){ 
            	  dom.addClass('linkable')//向dom中添加一个类 linkable
            ...
            }else if ($.inArray(nearest.node.name, ['证券','货币证券','资本证券','无价证券','有价证券']) >=0 ){//确定第一个参数在数组中的位置，若没有则返回-1
  ...
  $(document).ready(function(){
    ...
    var demos = {
      nodes:{
    	  证券:{color:"red", shape:"dot", alpha:1},    
             无价证券:{color:CLR.branch, shape:"dot", alpha:1}, 
             船票:{color:CLR.资本证券, alpha:1},
             机票:{color:CLR.资本证券, alpha:1},
             车票:{color:CLR.资本证券, alpha:1},
             
             有价证券:{color:CLR.branch, shape:"dot", alpha:1}, 
             资本证券:{color:CLR.b, shape:"dot", alpha:1}, 
             股票:{color:CLR.股票, alpha:1, link:'http://localhost:5858/test/src/main/webapp/index.html'},
             债券:{color:CLR.股票, alpha:1},
             货币证券:{color:CLR.b, shape:"dot", alpha:1},
             支票:{color:CLR.货币证券, alpha:1},
             汇票:{color:CLR.货币证券, alpha:1},
             本票:{color:CLR.货币证券, alpha:1},
