...
(function($){
  ...
  $(document).ready(function(){
    ...
    var demos = {
      nodes:{
    	  股票A:{color:CLR.branch, shape:"dot", alpha:1,tp:1},    
    	     股票B:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
    	     股票E:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
    	     股票F:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             股票G:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             
             股票C:{color:CLR.branch, shape:"dot", alpha:1,tp:1}, 
             股票H:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             股票I:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             股票J:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             
             股票D:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             股票K:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             股票L:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             股票M:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
             股票N:{color:CLR.branch, shape:"dot", alpha:1,tp:1},
    ...
    sys.parameters({stiffness:3000, repulsion:2000, gravity:true, dt:0.015})
    sys.graft(demos)
