(function(){
    ...
    var that = {
      ...
      redraw:function(){
        ...
        particleSystem.eachNode(function(node, pt){
         ...
         // gfx.oval(pt.x-5, pt.y-5, 10, 10, {fill:red, alpha:1})
  ...
  var Maps = function(elt){
    ...
    var _maps = {
    example:{title:"模拟", p:{stiffness:100}},
      usofa:{title:"沪市A股", p:{stiffness:600}},
      hushib:{title:"沪市B股", p:{stiffness:300}},
      ssa:{title:"深市A股", p:{stiffness:500}},
      shensb:{title:"深市B股", p:{stiffness:500}}
    ...
    var that = {
      ...
      selectMap:function(map_id){
        $.getJSON("maps/"+map_id+".json",function(data){
          ...
          sys.parameters(_maps[map_id].p)//改变界面参数——边缘刚度
  ...
  $(document).ready(function(){//在dom完成加载后立即加载
    var mcp = Maps("#maps")
