...
(function($){
  ...
  $(document).ready(function(){
    ...
    var demos = {
      nodes:{
    	  股票A:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:'http://localhost:5858/test/src/main/webapp/index4.html'},    
    	     股票B:{color:CLR.or, shape:"dot", alpha:1,tp:0,link:''},
    	     股票E:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:''},
    	     股票F:{color:CLR.or, shape:"dot", alpha:1,tp:0,link:''},
             股票G:{color:CLR.or, shape:"dot", alpha:1,tp:0,link:''},
             
             股票C:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:''}, 
             股票H:{color:CLR.or, shape:"dot", alpha:1,tp:0,link:'http://localhost:5858/test/src/main/webapp/index5.html'},
             股票I:{color:CLR.or, shape:"dot", alpha:1,tp:0,link:''},
             股票J:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:''},
             
             股票D:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:''},
             股票K:{color:CLR.or, shape:"dot", alpha:1,tp:0,link:''},
             股票L:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:''},
             股票M:{color:CLR.or, shape:"dot", alpha:1,tp:1,link:''},
             股票N:{color:CLR.or, shape:"dot", alpha:1,tp:0,link:''},
