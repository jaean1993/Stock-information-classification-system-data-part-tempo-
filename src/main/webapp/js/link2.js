...
*/
  ...
  $(document).ready(function(){
    ...
    var demos = {
      nodes:{股票H:{color:CLR.or, shape:"dot", alpha:1,type:0,linK:'http://localhost:5858/test/src/main/webapp/index.html'},    
    	     股票C:{color:CLR.or, shape:"dot", alpha:1,type:1,linK:''},
    	     股票A:{color:CLR.or, shape:"dot", alpha:1,type:1,linK:''},
    	     股票J:{color:CLR.or, shape:"dot", alpha:1,type:1,linK:''},
             股票I:{color:CLR.or, shape:"dot", alpha:1,type:0,linK:''},
             
             股票O:{color:CLR.or, shape:"dot", alpha:1,type:0,linK:''}, 
             股票Q:{color:CLR.or, shape:"dot", alpha:1,type:0,linK:'http://localhost:5858/test/src/main/webapp/index.html'},
             股票R:{color:CLR.or, shape:"dot", alpha:1,type:0,linK:''},
             股票T:{color:CLR.or, shape:"dot", alpha:1,type:1,linK:''},
             
             股票P:{color:CLR.or, shape:"dot", alpha:1,type:1,linK:''},
             股票U:{color:CLR.or, shape:"dot", alpha:1,type:0,linK:''},
             股票V:{color:CLR.or, shape:"dot", alpha:1,type:1,linK:''},
